...
class Prediction(models.Model):
    ...
    created_at = models.DateTimeField(auto_now_add=True, blank=True, null=True)  # Добавляем
    updated_at = models.DateTimeField(auto_now=True, blank=True, null=True)      # Добавляем
